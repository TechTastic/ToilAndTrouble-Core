...
import net.techtastic.tatcore.block.entity.CastIronOvenBlockEntity;
...
public class CastIronOvenBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.CAST_IRON_OVEN_BLOCK_ENTITY, CastIronOvenBlockEntity::tick);
    }
}
