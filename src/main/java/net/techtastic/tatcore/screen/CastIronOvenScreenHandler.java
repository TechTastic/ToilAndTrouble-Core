...
import net.techtastic.tatcore.screen.slot.ModFuelSlot;
import net.techtastic.tatcore.screen.slot.ModJarSlot;
import net.techtastic.tatcore.screen.slot.ModResultSlot;

public class CastIronOvenScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;

    public CastIronOvenScreenHandler(int syncId, PlayerInventory inventory) {
    ...
    public CastIronOvenScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        ...
        this.addSlot(new ModFuelSlot(inventory, 1, 44, 54));
        this.addSlot(new ModResultSlot(inventory, 2, 116, 19));
        this.addSlot(new ModJarSlot(inventory, 3, 80, 54));
